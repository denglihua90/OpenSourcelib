...
import com.mingle.widget.DividerItemDecoration;
...
public class RecyclerViewDelegate extends Delegate {
    ...
    protected View createView() {
        ...
        mRV.addItemDecoration(new DividerItemDecoration(mParentVG.getContext(), DividerItemDecoration.VERTICAL_LIST));
