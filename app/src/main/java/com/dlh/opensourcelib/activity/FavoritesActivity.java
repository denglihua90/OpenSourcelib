 ...
 * @DATE: 2016/5/10
 */
public class FavoritesActivity extends AppCompatActivity implements OnRefreshListener, OnLoadMoreListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listGridView = (RecyclerView) findViewById(R.id.swipe_target);
